...
CUDA_VISIBLE_DEVICES=6 python anycam/scripts/evaluate_trajectories.py \
    ...
    ++fit_video.prediction.flow_model=unimatch \
    ++fit_video.prediction.depth_predictor=unidepth \
    ++fit_video.prediction.mask_path=/data/zhuoyuan/code/Sa2VA/outputs/SA2VA_8B_lightspeed_uniform_keyframe_selector_num_samples_8 >> exps_BA/lightspeed_monst3r_BA_full_their_mask_lr_1e-5.txt