#!/bin/bash
# orig megasam
CUDA_VISIBLE_DEVICES=3 python anycam/scripts/evaluate_trajectories.py \
    ...
    ++fit_video.prediction.recon_data_path=/data2/zhuoyuan/cvpr2026/monst3r \
    ++fit_video.do_ba_refinement=false \
    ++out_path=/data/zhuoyuan/anycam_exp/ \
    ++fit_video.prediction.use_provided_depth=false \
    ...
    ++fit_video.prediction.depth_predictor=unidepth \
    ++fit_video.prediction.mask_path=/data/zhuoyuan/code/Sa2VA/outputs/SA2VA_8B_lightspeed_uniform_keyframe_selector_num_samples_8 >> exps_BA/lightspeed_monst3r_wo_BA_full.txt


#  anycam + BA
# CUDA_VISIBLE_DEVICES=7 python anycam/scripts/evaluate_trajectories.py \
#     -cn evaluate_trajectories \
#     ++other_model=megasam \
#     ++model_path=pretrained_models/anycam_seq8 \
#     ++dataset=anycam/configs/dataset_cfgs/lightspeed.yaml \
#     ++fit_video.dataset_type=lightspeed \
#     ++fit_video.prediction.recon_data_path=/data/zhuoyuan/code/mega-sam/reconstructions_lightspeed \
...
#     ++fit_video.prediction.metric_depth_path=/data/zhuoyuan/code/mega-sam/UniDepth/outputs \
#     ++fit_video.prediction.mono_depth_path=/data/zhuoyuan/code/mega-sam/Depth-Anything/video_visualization \
#     ++fit_video.prediction.use_provided_masks=true \
#     ++fit_video.prediction.use_provided_flow=false \
#     ++fit_video.prediction.flow_model=unimatch \
#     ++fit_video.prediction.depth_predictor=unidepth \
#     ++fit_video.prediction.mask_path=/data/zhuoyuan/code/Sa2VA/outputs/SA2VA_8B_lightspeed_uniform_keyframe_selector_num_samples_8 >> exps_BA/lightspeed_megasam_ba_full.txt