...
CUDA_VISIBLE_DEVICES=2 python anycam/scripts/evaluate_trajectories.py \
    ...
    ++fit_video.prediction.recon_data_path=/data2/zhuoyuan/cvpr2026/TTT3r \
    ...
    ++fit_video.prediction.mask_path=/data/zhuoyuan/code/Sa2VA/outputs/SA2VA_8B_lightspeed_uniform_keyframe_selector_num_samples_8 >> exps_BA/lightspeed_ttt3r_wo_BA_full.txt
